...
const Header = () => {
  ...
  return (
    <header>
      <div className="flex flex-wrap justify-between items-center mx-auto py-2 md:p-4 w-full">
        <a
          href={`/${currentLocal}`}
      ...
      <div
        className={`fixed z-20 top-0  bottom-0 w-full transition-all overflow-hidden ${
